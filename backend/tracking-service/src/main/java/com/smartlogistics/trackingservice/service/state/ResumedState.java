...
public class ResumedState implements TripState {

    @Override
    public void assign(Trip trip) {
        throw new InvalidTripStateException("Cannot assign a resumed trip.");
    }

    @Override
    public void ready(Trip trip) {
        throw new InvalidTripStateException("Cannot transition to READY from RESUMED.");
    }
